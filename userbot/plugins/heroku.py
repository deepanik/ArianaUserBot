...
async def _(dyno):        
        try:
  	       ...
  	       return await dyno.reply(" Please make sure your Heroku API Key, Your App name are configured correctly in the heroku Please Join @AnianaUserBot For Any Issue")
        ...
        await dyno.delete()
        return os.remove('ArianaUserBotlogs.txt')
